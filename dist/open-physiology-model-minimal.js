...
/***/ function(module, exports, __webpack_require__) {
	...
	var _trim = __webpack_require__(241);
	...
	var _isNumber = __webpack_require__(235);
	...
	var _isSet = __webpack_require__(130);
	
	var _isSet2 = _interopRequireDefault(_isSet);
	
	var _isWeakSet = __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(351);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHas = __webpack_require__(144),
	    baseKeys = __webpack_require__(274),
	    indexKeys = __webpack_require__(152),
			...
			value: function initializeEntity(owner, initialValues) {
				...
				var waitUntilConstructed = function waitUntilConstructed() {
					...
					if (entity === owner) {
						...
						return _rxjs.Observable.concat(constructingOwner, this);
					} else {
						return _rxjs.Observable.concat(entity.p('fieldsInitialized'), this);
					}
				};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _schemas = __webpack_require__(31);
	...
	exports.default = _Module2.default.create('resources', [], function (M) {
		...
		var IsRelatedTo = M.RELATIONSHIP({
			...
			properties: {
				'id': _extends({}, _schemas.idSchema, { readonly: true }), // TODO: id will disappear from relationships in future refactoring
				'class': _extends({}, _schemas.identifierSchema, { readonly: true })
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLength = __webpack_require__(308),
	    isFunction = __webpack_require__(77),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Module2 = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _global = __webpack_require__(194);
	
	var _global2 = _interopRequireDefault(_global);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var Rx = _global2.default.Rx;
	exports.default = Rx;
	var Observable = exports.Observable = Rx.Observable;
	var Subject = exports.Subject = Rx.Subject;
	var BehaviorSubject = exports.BehaviorSubject = Rx.BehaviorSubject;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(350);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assignWith = __webpack_require__(230);
	...
	var _fromPairs = __webpack_require__(233);
	
	var _fromPairs2 = _interopRequireDefault(_fromPairs);
	
	var _cloneDeep = __webpack_require__(126);
	...
	var _isEqual2 = __webpack_require__(360);
	
	var _isEqual3 = _interopRequireDefault(_isEqual2);
	
	var _graph = __webpack_require__(125);
	...
	var _fields = __webpack_require__(121);
	
	var _Command = __webpack_require__(178);
	...
	var Environment = function () {
		function Environment(envOrBackend) {
						...
						while (1) {
							switch (_context7.prev = _context7.next) {
								case 0:
									...
									commands = (_context6 = commands, _cloneDeep2.default).call(_context6);
								...
								case 3:
									...
									_context7.t0 = localCommand.commandType;
									_context7.next = _context7.t0 === 'new' ? 9 : _context7.t0 === 'edit' ? 14 : _context7.t0 === 'delete' ? 18 : 22;
									break;
								...
								case 11:
									localResponse = _context7.sent;
	
									if (temporaryIds.includes(localCommand.values.id)) {
										temporaryId = localCommand.values.id;
										newId = localResponse.id;
	
										response.temporaryIds[temporaryId] = newId;
										for (j = i + 1; j < commands.length; ++j) {
											futureCommand = commands[j];
	
											replaceTemporaryIds({ futureCommand: futureCommand, temporaryId: temporaryId, newId: newId });
										}
									}
								...
								case 27:
									return _context7.abrupt('return', _cloneDeep2.default.call(response));
			...
			function replaceTemporaryIds(_ref2) {
							...
							try {
								for (var _iterator = fieldKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
									...
									if ((_context3 = futureCommand.values[key], _isArray2.default).call(_context3)) {
										idObjects.push.apply(idObjects, _toConsumableArray(futureCommand.values[key]));
									} else {
							...
							try {
								for (var _iterator2 = _fieldKeys[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
									...
									if ((_context5 = futureCommand.newValues[_key], _isArray2.default).call(_context5)) {
										idObjects.push.apply(idObjects, _toConsumableArray(futureCommand.newValues[_key]));
									} else {
										idObjects.push(futureCommand.newValues[_key]);
									}
								}
							} catch (err) {
								_didIteratorError2 = true;
				...
				try {
					for (var _iterator3 = idObjects[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
						var idObject = _step3.value;
		...
		_createClass(Environment, [{
			...
			value: function registerModule(module, dependencies, fn) {
				...
				if (fn) {
					...
					fn(module, (_context8 = [].concat(_toConsumableArray(this.classes.vertices())), _fromPairs2.default).call(_context8));
				}
			}
		}]);
		...
		_createClass(Module, [{
			...
			value: function mergeSuperclassFields(cls) {
				var mergeFieldKind = function mergeFieldKind(cls, newCls, kind, customMerge) {
					...
					if ((_context10 = cls[kind], _isUndefined2.default).call(_context10)) {
						return;
					}
					...
					function mergeBetween(superCls, subCls) {
						...
						try {
							for (var _iterator11 = (_context11 = superCls[kind], _keys2.default).call(_context11)[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
								var _context11;
				...
				mergeFieldKind(cls, cls, 'properties', function (superDesc, subDesc) {
					...
					if ((_context12 = superDesc.type, _isUndefined2.default).call(_context12) && superDesc.oneOf) {
						...
						try {
							for (var _iterator14 = superDesc.oneOf[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
								...
								if (_typeof(subDesc.value) === disjunct.type || (_context13 = subDesc.value, _isInteger2.default).call(_context13) && disjunct.type === 'integer' || (0, _isEqual3.default)(subDesc.value, disjunct.value)) {
			...
			value: function mergeSameNameRelationships(NewClass) {
				...
				return _assignWith2.default.call(OldClass, NewClass, function (vOld, vNew, key) {
					...
					switch (key) {
						...
						case 'patternProperties':
						case 'behavior':
							return (_context15 = {}, _assignWith2.default).call(_context15, vOld, vNew, function (pOld, pNew, pKey) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TypedModule = __webpack_require__(29);
	...
	var _union2 = __webpack_require__(385);
	...
	var _max = __webpack_require__(237);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wu2 = __webpack_require__(390);
	...
	function hybrid(ld, name) {
		return function () {
			if (_instanceof(this, _rxjs.Observable)) {
				return this[name].apply(this, arguments);
			} else if (typeof this.next === 'function') {
				var _wu;
	
				return (_wu = (0, _wu3.default)(this))[name].apply(_wu, arguments);
	...
	var filter = exports.filter = hybrid(_filter2.default, 'filter');
	
	// import {map as rx_map} from 'rxjs/operator/map';
	var map = exports.map = hybrid(_map2.default, 'map');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lyphs = __webpack_require__(42);
	
	var _lyphs2 = _interopRequireDefault(_lyphs);
	
	var _processes = __webpack_require__(85);
...
/***/ function(module, exports) {
	...
	var $$entitiesById = exports.$$entitiesById = Symbol('$$entitiesById');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _includes = __webpack_require__(234);
	...
	var _set = __webpack_require__(240);
	...
	var _isBoolean2 = __webpack_require__(358);
	...
	var ValueTracker = (_dec = (0, _misc.args)('s?a?a?f?'), (_class = function () {
		...
		function ValueTracker() {
			...
			this[$$takeUntil] = _rxjs.Observable.never();
	   ...
	   */
			...
			value: function newEvent(name) {
				...
				this[$$events][name] = new _rxjs.Subject().takeUntil(this[$$takeUntil]).filter(this[$$filterBy]);
	   ...
	   */
			...
			value: function newProperty(name) {
				...
				if ((_context3 = initial, _isFunction2.default).call(_context3)) {
					initial = initial.call(this);
				}
	
				/* define the bus which manages the property */
				var subject = this[$$settableProperties][name] = new _rxjs.BehaviorSubject(initial)
				// .filter(this[$$filterBy] )
				.filter(isValid.bind(this)).map(transform.bind(this))
				// .takeUntil(this[$$takeUntil])
				.distinctUntilChanged(isEqual.bind(this)).filter(function (v) {
					return v !== invalidCache;
				});
				this[$$properties][name] = readonly ? subject.asObservable() : subject;
	
				var invalidCache = Symbol();
				subject.invalidateCache = function () {
				...
				this[$$events][name] = subject.asObservable().skip(1); // skip 'current value' on subscribe
	   ...
	   */
			...
			value: function e(name) {
				this[$$initialize]();
				return this[$$events][name] || _rxjs.Observable.never();
			}
		}, {
			key: 'hasProperty',
	   ...
	   */
			...
			value: function p(name, deps) {
				...
				this[$$initialize]();
				if (deps) {
					var _Observable$combineLa;
	
					return (_Observable$combineLa = _rxjs.Observable.combineLatest.apply(_rxjs.Observable, _toConsumableArray(deps.map(this.p.bind(this))))).withLatestFrom.apply(_Observable$combineLa, _toConsumableArray(optionalPassiveDeps.map(this.p.bind(this))).concat([function (active) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(361);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListCache = __webpack_require__(67),
	    stackClear = __webpack_require__(338),
	    stackDelete = __webpack_require__(339),
	    stackGet = __webpack_require__(340),
	    stackHas = __webpack_require__(341),
	    stackSet = __webpack_require__(342);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(349);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(356);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var overArg = __webpack_require__(113),
	    stubArray = __webpack_require__(381);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reject = __webpack_require__(239);
	
	var _reject2 = _interopRequireDefault(_reject);
	
	var _misc = __webpack_require__(2);
	
	var _ObservableSet = __webpack_require__(87);
	...
	var _boundHybridFunctions = __webpack_require__(43);
	
	var _boundNativeMethods = __webpack_require__(10);
	
	var _babelHelpers = __webpack_require__(193);
	
	var _babelHelpers2 = _interopRequireDefault(_babelHelpers);
	
	var _Command_new = __webpack_require__(182);
	
	var _Command_new2 = _interopRequireDefault(_Command_new);
	
	var _Command_delete = __webpack_require__(179);
	
	var _Command_delete2 = _interopRequireDefault(_Command_delete);
	
	var _Command_edit = __webpack_require__(180);
	
	var _Command_edit2 = _interopRequireDefault(_Command_edit);
	
	var _Command_load = __webpack_require__(181);
	
	var _Command_load2 = _interopRequireDefault(_Command_load);
	
	var _symbols = __webpack_require__(86);
			...
			_createClass(Entity, [{
				...
				value: function normalizeAddress(address) {
					...
					if (_isObject2.default.call(address)) {
						var _id = address.id || entityToTemporaryId.get(address);
						return { class: address.class || this.name, id: _id };
					}
				}
				...
				value: function createClass(config) {
					...
					for (var _i = 0; _i < _arr.length; _i++) {
						...
						Entity[$$set].e('delete').filter(EntitySubclass.hasInstance.bind(EntitySubclass)).subscribe(localSet.e('delete'));
				...
				value: function getLocal(entityOrAddress) {
					...
					if (!Entity[_symbols.$$entitiesById][address.id]) {
						return;
					}
	
					/* fetch the entity (or placeholder) from the cache */
					var entity = Entity[_symbols.$$entitiesById][address.id];
	
					/* make sure the retrieved entity is of the expected class */
					(0, _misc.constraint)(this.hasInstance(entity), (0, _misc.humanMsg)(_templateObject2, JSON.stringify(address.id), this.name, entity.constructor.name));
						...
						return regeneratorRuntime.wrap(function _callee$(_context2) {
							while (1) {
								switch (_context2.prev = _context2.next) {
									case 0:
										useArray = (_context = addresses, _isArray2.default).call(_context);
										...
										absentAddresses = (_context = (_context = addresses, _boundHybridFunctions.map).call(_context, this.normalizeAddress.bind(this)), _reject2.default).call(_context, this.hasCache.bind(this));
									...
									case 32:
										...
										result = (_context = addresses, _boundHybridFunctions.map).call(_context, function (addr) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uniqueId2 = __webpack_require__(386);
	...
	var _last = __webpack_require__(132);
	...
	var _parseInt = __webpack_require__(238);
	
	var _parseInt2 = _interopRequireDefault(_parseInt);
	
	var _every = __webpack_require__(231);
	
	var _every2 = _interopRequireDefault(_every);
	
	var _size = __webpack_require__(99);
	...
	var _deepFreezeStrict = __webpack_require__(47);
	
	var _deepFreezeStrict2 = _interopRequireDefault(_deepFreezeStrict);
	
	var _ValueTracker = __webpack_require__(88);
			...
			_createClass(Command_batch, [{
				...
				value: function () {
					var _ref23 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
						...
						var associatedEntities, _iteratorNormalCompletion20, _didIteratorError20, _iteratorError20, _iterator20, _step20, command, _iteratorNormalCompletion24, _didIteratorError24, _iteratorError24, _iterator24, _step24, _entity, temporaryIds, entityToTemporaryId, _iteratorNormalCompletion21, _didIteratorError21, _iteratorError21, _iterator21, _step21, _entity2, id, commandListJSON, tmpIdsSeen, i, localCommand, localCommandJSON, entity, valuesJSON, _iteratorNormalCompletion22, _didIteratorError22, _iteratorError22, _iterator22, _step22, _step22$value, key, valueJSON, _iteratorNormalCompletion23, _didIteratorError23, _iteratorError23, _iterator23, _step23, _step23$value, _i2, valJSON;
								...
								switch (_context10.prev = _context10.next) {
									...
									case 44:
										...
										for (_iterator21 = associatedEntities[Symbol.iterator](); !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
											...
											if (!_entity2.id && !entityToTemporaryId.has(_entity2)) {
												id = newTemporaryId();
	
												entityToTemporaryId.set(_entity2, id);
												temporaryIds.add(id);
											}
										}
									...
									case 65:
										...
										commandListJSON = (_context9 = this.commandList, _boundHybridFunctions.map).call(_context9, function (cmd) {
											return cmd.toJSON({
												entityToTemporaryId: entityToTemporaryId,
		...
		return _temp = _class = function (_cls$TrackedCommand) {
			...
			_createClass(Command_delete, [{
				...
				value: function localRun() {
					...
					try {
						for (var _iterator = (_context = this.entity.fields, keys).call(_context)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
							var _context;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['\n\t\t\t\tCannot instantiate the abstract\n\t\t\t\tclass ', '.\n\t\t\t'], ['\n\t\t\t\tCannot instantiate the abstract\n\t\t\t\tclass ', '.\n\t\t\t']),
	    _templateObject2 = _taggedTemplateLiteral(['\n\t\t\t\tExpected ', ' to be\n\t\t\t\ta subclass of ', '.\n\t\t\t'], ['\n\t\t\t\tExpected ', ' to be\n\t\t\t\ta subclass of ', '.\n\t\t\t']),
	    _templateObject3 = _taggedTemplateLiteral(['\n\t\t\t\tCannot load data into the ', '\n\t\t\t\twith id="', '", because it has local changes.\n\t\t\t'], ['\n\t\t\t\tCannot load data into the ', '\n\t\t\t\twith id="', '", because it has local changes.\n\t\t\t']),
	    _templateObject4 = _taggedTemplateLiteral(['\n\t\t\t\t\tExpected ', ' to be\n\t\t\t\t\ta subclass of ', '.\n\t\t\t\t'], ['\n\t\t\t\t\tExpected ', ' to be\n\t\t\t\t\ta subclass of ', '.\n\t\t\t\t']),
	...
	var _symbols2 = __webpack_require__(19);
				...
				value: function localRun() {
					...
					if (!this.result) {
						...
						if (!this.placeholder) {
							...
							this.result[_symbols2.$$id] = values.id;
						}
						...
						cls[_symbols.$$entitiesById][this.values.id] = this.result;
						...
						/* sanity checks */
						(0, _misc.constraint)(this.result.isPristine, (0, _misc.humanMsg)(_templateObject3, this.result.class, this.result.id));
		...
		return _temp = _class = function (_cls$TrackedCommand) {
			...
			_createClass(Command_new, [{
				...
				value: function localRun() {
					...
					/* pre-store by id */
					if (this.options.acceptId && (_context = values.id, _isInteger2.default).call(_context)) {
						cls.Entity[_symbols.$$entitiesById][values.id] = this.result;
					}
				}
			}, {
				key: 'toJSON',
				value: function toJSON() {
					...
					return {
						...
						values: cls.objectToJSON(_extends({}, this.resultingValues, {
							class: cls.name
						}, entityToTemporaryId.has(this.result) ? { id: entityToTemporaryId.get(this.result) } : {}), _extends({}, options, {
				...
				value: function localHandleCommitResponse(response) {
					...
					if (this.options.acceptId && (_context4 = this.initialValues.id, _isInteger2.default).call(_context4)) {}
					...
					/* maintain caches */
					cls.Entity[_symbols.$$entitiesById][response.id] = this.result;
				...
				value: function localRollback() {
					...
					delete cls.Entity[_symbols.$$entitiesById][this.result.id];
...
/***/ function(module, exports, __webpack_require__) {
	...
	_Field2.Field[_symbols.$$registerFieldClass](function (_Field) {
		...
		function PropertyField(options) {
			...
			owner.p('isPlaceholder').filter(function (v) {
				return !v;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inRange = __webpack_require__(128);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // TODO: make sure we don't need to import this anymore: switchMap;
	...
	_Field.Field[_symbols.$$registerFieldClass](function (_RelField) {
		...
		function Rel$Field(options) {
			...
			(_context3 = _this[_symbols.$$value].e('add'), waitUntilConstructed).call(_context3).switchMap(function (rel) {
				return rel.p('fieldsInitialized').filter(function (v) {
					return !!v;
				}).map(function () {
					return rel;
				});
			...
			(_context3 = _this[_symbols.$$value].e('add'), waitUntilConstructed).call(_context3).switchMap(function (newRel) {
				...
				return newRel.fields[desc.keyInRelationship].p('value').filter(function (res) {
					return res !== owner;
				}).map(function () {
					return newRel;
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isNull = __webpack_require__(129);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // TODO: make sure we don't need to import this anymore: map;
	// TODO: make sure we don't need to import this anymore: filter;
	// TODO: make sure we don't need to import this anymore: pairwise;
	// TODO: make sure we don't need to import this anymore: switchMap;
	// TODO: make sure we don't need to import this anymore: startWith;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // TODO: make sure we don't need to import this anymore: pairwise;
	// TODO: make sure we don't need to import this anymore: takeUntil;
	// TODO: make sure we don't need to import this anymore: take;
	// TODO: make sure we don't need to import this anymore: startWith;
	// import 'rxjs/add/operator/do';
	...
	_Field.Field[_symbols.$$registerFieldClass](function (_RelField) {
		...
		function RelShortcut$Field(options) {
			...
			(_context3 = correspondingRelField.e('add'), waitUntilConstructed).call(_context3).switchMap(function (newRel) {
				return newRel.p('fieldsInitialized').filter(function (v) {
					return !!v;
				}).map(function () {
					return newRel;
				...
				var newRelDisconnected = newRel.fields[desc.keyInRelationship].p('value').filter(function (v) {
					return v !== owner;
				}).take(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // TODO: make sure we don't need to import this anymore: filter;
	// TODO: make sure we don't need to import this anymore: switchMap;
	...
	_Field.Field[_symbols.$$registerFieldClass](function (_RelField) {
		...
		function RelShortcut1Field(options) {
			...
			var correspondingRelValue = (_context3 = _rxjs.Observable.defer(function () {
			...
			correspondingRelValue.filter(function (v) {
				return v;
			}).switchMap(function (rel) {
				return rel.p('fieldsInitialized').filter(function (v) {
					return !!v;
				}).mapTo(rel);
			}).switchMap(function (rel) {
			...
			/* keep the relationship up to date */
			(_context3 = _this.p('value')
			// .do((v) => {
			// 	console.log('relshortcutfield value:', v);
			// })
			, waitUntilConstructed).call(_context3).subscribe(function (scValue) {
				...
				if (relValue && relValue[desc.codomain.keyInRelationship]) {
					...
					relValue.p('fieldsInitialized').filter(function (v) {
						return !!v;
					}).take(1).takeUntil(_this.p('value').filter(function (v) {
						return v !== scValue;
					})).subscribe(function () {
					...
					var forcedDep = (_context4 = owner.editCommands, _last2.default).call(_context4) || owner.originCommand;
...
/***/ function(module, exports, __webpack_require__) {
	...
	_Field2.Field[_symbols.$$registerFieldClass](function (_Field) {
		...
		function SideField(options) {
			...
			(_context2 = _this.p('value'), waitUntilConstructed).call(_context2).filter(function (v) {
				return v === null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _groups = __webpack_require__(122);
	
	var _groups2 = _interopRequireDefault(_groups);
	
	var _measurables = __webpack_require__(84);
	...
	var _canonicalTrees = __webpack_require__(190);
	
	var _canonicalTrees2 = _interopRequireDefault(_canonicalTrees);
	
	var _research = __webpack_require__(191);
	
	var _research2 = _interopRequireDefault(_research);
	
	var _visualisations = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(346);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(348);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(352);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(353);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(354);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(357);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fn = __webpack_require__(363);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflect = __webpack_require__(245),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var basePickBy = __webpack_require__(280);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetCache = __webpack_require__(136),
	    ...
	    createSet = __webpack_require__(303),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addSetEntry = __webpack_require__(248),
	    arrayReduce = __webpack_require__(140),
	    setToArray = __webpack_require__(76);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseToPairs = __webpack_require__(284),
	    getTag = __webpack_require__(52),
	    mapToArray = __webpack_require__(112),
	    setToPairs = __webpack_require__(337);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cloneArrayBuffer = __webpack_require__(109),
	    cloneDataView = __webpack_require__(292),
	    cloneMap = __webpack_require__(293),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reHasComplexSymbol = __webpack_require__(334);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var memoize = __webpack_require__(372),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseClone = __webpack_require__(256);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apply = __webpack_require__(138),
	    assignInDefaults = __webpack_require__(254),
	    assignInWith = __webpack_require__(347),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayEvery = __webpack_require__(250),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHasIn = __webpack_require__(266),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseInRange = __webpack_require__(267),
	    toFinite = __webpack_require__(160),
	    toNumber = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {var root = __webpack_require__(13),
	    stubFalse = __webpack_require__(382);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseKeysIn = __webpack_require__(275),
	    indexKeys = __webpack_require__(152),
	    isIndex = __webpack_require__(53),
	    isPrototype = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseExtremum = __webpack_require__(259),
	    baseGt = __webpack_require__(265),
	    identity = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(49),
	    ...
	    basePick = __webpack_require__(279),
	    baseRest = __webpack_require__(50),
	    toKey = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayFilter = __webpack_require__(104),
	    ...
	    baseIteratee = __webpack_require__(72),
	    isArray = __webpack_require__(4),
	    negate = __webpack_require__(373);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getTag = __webpack_require__(52),
	    ...
	    isString = __webpack_require__(56),
	    keys = __webpack_require__(12),
	    stringSize = __webpack_require__(343);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createToPairs = __webpack_require__(304),
	    keys = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseToString = __webpack_require__(146),
	    castSlice = __webpack_require__(288),
	    charsEndIndex = __webpack_require__(289),
	    charsStartIndex = __webpack_require__(290),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayFilter = __webpack_require__(104),
	    ...
	    baseProperty = __webpack_require__(107),
	    baseTimes = __webpack_require__(145),
	    isArrayLikeObject = __webpack_require__(115);
